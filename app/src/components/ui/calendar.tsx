  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          "pointer-events-auto inline-flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-surface text-body shadow-sm hover:bg-cream hover:text-heading transition-colors",
        button_next:
          "pointer-events-auto inline-flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-surface text-body shadow-sm hover:bg-cream hover:text-heading transition-colors",
